...
Below you can find a list of the data resulting from EMHASS computation, showin in the graphs and then published to Home Assistant through the ```publish_data``` command:
