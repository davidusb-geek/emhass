...
curl -i -H 'Content-Type:application/json' -X POST -d '{"p10":[80,80,80],"p50":[100,100,100],"actual":[70,90,90],"target_shortfall_rate":0.10}' http://localhost:5000/action/pv-bias-calibration
