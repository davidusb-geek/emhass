...
from emhass.helpers.weather_forecast_helper import WeatherForecastHelper
...
class Forecast:
    ...
    def __init__(
        ...
        """
        self.weather_forecast_helper = WeatherForecastHelper(self)
    ...
    async def get_weather_forecast(
        ...
        if method == "open-meteo" or method == "scrapper":
            data = await self.weather_forecast_helper.get_open_meteo_forecast(w_forecast_cache_path)
        elif method == "solcast":
            data = await self.weather_forecast_helper.get_solcast_forecast(w_forecast_cache_path)
        elif method == "solar.forecast":
            data = await self.weather_forecast_helper.get_solar_forecast(w_forecast_cache_path)
        elif method == "csv":
            data = self.weather_forecast_helper.get_csv_forecast(csv_path)
        elif method == "list":
            data = self.weather_forecast_helper.get_list_forecast()
        else:
