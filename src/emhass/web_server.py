...
def build_params(params, options, addon):
    if addon == 1:
        ...
        params['retrieve_hass_conf'][6]['load_negative'] = [options['load_negative']]
        params['retrieve_hass_conf'][6]['set_zero_min'] = [options['set_zero_min']]
        ...
        params['retrieve_hass_conf'][8]['solcast_api_key'] = options['optional_solcast_api_key']
        params['retrieve_hass_conf'][8]['solcast_rooftop_id'] = options['optional_solcast_rooftop_id']
        params['retrieve_hass_conf'][8]['solar_forecast_kwp'] = options['optional_solar_forecast_kwp']
        ...
        params['optim_conf'][8]['weather_forecast_method'] = options['weather_forecast_method']
        ...
        params['optim_conf'][8]['load_cost_forecast_method'] = options['load_cost_forecast_method']
